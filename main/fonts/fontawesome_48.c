 ...
 * Size: 48 px
 * Bpp: 1
 * Opts: --bpp 1 --size 48 --no-compress --font FontAwesome5-Solid+Brands+Regular.woff --range 61459 --format lvgl -o fontawesome_48.c
 ******************************************************************************/
...
extern const lv_font_t lv_font_monserrat_48;
